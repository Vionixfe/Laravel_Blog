    ...
    <div class="row g-4">
        <div class="col-12">
            <div class="p-3 rounded border">
                ...
                <div class="row g-4">
                    <div class="col-12">
                        <a href="https://www.facebook.com/sharer/sharer.php?u={{ url()->current() }}&quote={{ $article->title }}"
                            target="_blank" title="Share on Facebook" class="w-100 rounded btn btn-primary d-flex align-items-center p-3 mb-2">
                            <i class="fab fa-facebook-f btn btn-light btn-square rounded-circle me-3"></i>
                            <span class="text-white">Share on Facebook</span>
                        </a>
                        <a href="https://www.youtube.com/share?u={{ url()->current() }}" target="_blank" title="Share on YouTube" class="w-100 rounded btn btn-danger d-flex align-items-center p-3 mb-2">
                            <i class="fab fa-youtube btn btn-light btn-square rounded-circle me-3"></i>
                            <span class="text-white">Subscribe on YouTube</span>
                        </a>
