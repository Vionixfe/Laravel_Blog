...
use App\Http\Controllers\Backend\VerifiedController;
...
Route::prefix('admin')->group(function () {
    // Rute untuk halaman dashboard menggunakan DashboardController
    ...
    // confirm
    Route::patch('articles/{uuid}/confirm', [ConfirmController::class, 'update'])->name('admin.articles.confirm');
    ...
    ->only('index', 'show', 'edit', 'update', 'destroy')
        ->names('admin.writers');
         ...
         // confirm verified
    Route::patch('writers/{id}/verified', [VerifiedController::class, 'update'])->name('admin.writers.verified');
});
