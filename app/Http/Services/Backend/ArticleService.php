            ...
            return DataTables::of($data)
                ...
                ->editColumn('is_confirm', function ($data) {
                        ...
                        if ($data->is_confirm == 1) {
                            ...
                            return '<span class="badge bg-danger">Unconfirm</span>';
                        }
                ...
                ->addColumn('action', function ($data) {
                    ...
                    if (auth()->user()->hasRole('owner')) {
                        $actionBtn .= '
                            <button type="button" class="btn btn-sm btn-warning" onclick="editConfirm(this)" data-id="' . $data->uuid . '">
                ...
                ->rawColumns(['title', 'category_id', 'tag_id', 'published', 'views', 'action','is_confirm'])
                ->with([
